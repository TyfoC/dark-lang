...
namespace Dark {
	enum TokenType : size_t {
		...
		TOKEN_TYPE_OPERATOR_PREPROCESSOR_BLOCK_START,	//	<@
		TOKEN_TYPE_OPERATOR_PREPROCESSOR_BLOCK_END,	//	@>
	...
	const std::vector<Token> Lexemes = {
		...
		{ TOKEN_TYPE_OPERATOR_PREPROCESSOR_BLOCK_START, R"(<@)" },
		{ TOKEN_TYPE_OPERATOR_PREPROCESSOR_BLOCK_END, R"(@>)" },
